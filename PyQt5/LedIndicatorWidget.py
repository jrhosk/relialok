...
class LedIndicator(QAbstractButton):
    ...
    def __init__(self, parent=None, **kawgs):
        ...
        if 'color' in kawgs:
            if kawgs['color'] is 'green':
                # Green
                self.on_color_1 = QColor(0, 255, 0)
                self.on_color_2 = QColor(0, 192, 0)
                self.off_color_1 = QColor(0, 28, 0)
                self.off_color_2 = QColor(0, 128, 0)
            elif kawgs['color'] is 'blue':
                # Green
                self.on_color_1 = QColor(0,191,255)
                self.on_color_2 = QColor(0, 0, 192)
                self.off_color_1 = QColor(0, 0, 28)
                self.off_color_2 = QColor(0, 0, 128)
            else:
